...
public class EditSong extends AppCompatActivity {
    ...
    sg.edu.rp.c346.id20002694.project13.Song data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        data = (sg.edu.rp.c346.id20002694.project13.Song) i.getSerializableExtra("data");
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sg.edu.rp.c346.id20002694.project13.DBHelper dbh = new sg.edu.rp.c346.id20002694.project13.DBHelper(sg.edu.rp.c346.id20002694.project13.EditSong.this);
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder myBuilder = new AlertDialog.Builder(sg.edu.rp.c346.id20002694.project13.EditSong.this);
                ...
                myBuilder.setNegativeButton("go back", null);
